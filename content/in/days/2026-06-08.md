...
memorial: "Blessed Mariam Thressia – Memorial (For India)"
psalterWeek: 2
sections:
  - key: first_reading
    title: First Reading
  ...
  - key: responsorial_psalm
    ...
    audio: null
    body: |
      <span class="resp-label">Response:</span>*OurhelpisfromtheLordwhomadeheavenandearth.*
  ...
  - key: gospel
    ...
    body: |
      ...
      ‘Happy are you when people abuse you and persecute you and speak <span class="speaker">all</span> kinds of calumny against you on my account. Rejoice and be glad, for your reward will be great in heaven; this is how they persecuted the prophets before you.’
  - key: homily
    title: Homily Tip
    ref: "Matthew 5:1–12"
    audio: null
    body: |
      The“Beatitudes” form the introductory section in Mathew’s account of the *Sermon on the Mount.* They are the heart of the Sermon on the Mount, as the Sermon on the Mount is the heart of the whole Gospel, or the “Compendium of Christian Doctrine*.”* This sermon contains the most essential aspects of Christian behaviour that we need to live out, if we are to reach Christian perfection. In essence, the Beatitudes both fulfil and complete the Ten Commandments.
  ...
  - key: intercessions
    ...
    audio: null
    body: |
      <span class="celebrant">Celebrant:</span> Jesus teaches us the Beatitudes, showing us the way to true happiness. Let us pray for the grace to live as blessed children of God.
      ...
      That the Church may always be a voice for the poor, the meek, and those who hunger for righteousness. We pray to the Lord.
      ...
      That those who mourn may be comforted by the presence of Christ and the love of those around them. We pray to the Lord.
      ...
      That peacemakers may work tirelessly to bring reconciliation and healing to divided communities. We pray to the Lord.
      ...
      That we may seek humility, purity, and mercy in all our actions. We pray to the Lord.
      ...
      That we may embrace the call to holiness by living out the Beatitudes in our daily lives. We pray to the Lord.
      ...
      <span class="celebrant">Celebrant:</span> Merciful Father, you have shown us the path to true happiness. Help us to follow You and live according to Your teachings. We make this prayer through Christ our Lord. Amen.
---
